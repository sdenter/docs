...
::: info Only if your app backend server and Shopware need to communicate it is necessary that registration is performed during the installation of your app. This process is called setup. :::
